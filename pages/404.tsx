    ...
    return (
        <div className='w-full min-h-[calc(100vh-232px)] grid grid-cols-1 md:grid-cols-2 mb-52 md:mb-0'>
            <div className='p-4 flex flex-col items-center md:items-end justify-center'>
                ...
                <Link href="/" >
                    <a className="p-4 border-2 border-primary rounded-md text-primary hover:bg-primary hover:text-base active:text-sm flex w-fit gap-3 hover:fill-base fill-primary items-center">
                        <div>
