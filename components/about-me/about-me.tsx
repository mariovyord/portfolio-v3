...
const About = () => {
    const biography = (
        <div className='flex flex-col gap-2'>
            <p>const <span className='text-orange-400'>FrontEndDeveloper</span> = ( &#123; ReactJS &#125; ) =&gt; &#123;</p>
            <p className=' pl-4'>return (</p>
            <p className='pl-8'>
                Hey! I enjoy building web apps with  <span className='text-primary'>ReactJS</span>. MERN stack as a whole is pretty fun. I study JavaScript and its ecosystem at <span className='text-primary'>SoftUni Bulgaria</span> and on my own. My professional experience is in print as a Prepress Specialist, where I have worked on hundreds of books over the years.
            </p>
            <p className='pl-8'>
                My main goal is growing as a <span className='text-primary'>Front-End Developer</span>. But of course as the famous quote goes:
            </p>
    ...
    return (
        <section id="about" className='pb-2 pt-24 px-2'>
            <h1 className='font-black uppercase text-5xl text-center mb-4'>About</h1>
