...
const ArticleFooter = () => {
    return (
        <>
            <Link href="/blog" className="p-4 border-2 border-primary rounded-md text-primary hover:bg-primary hover:text-base active:text-sm flex w-fit gap-3 hover:fill-base fill-primary items-center">
                <div>
