...
const FocusList = () => {
    const list = [
        { link: '#skills', text: 'focusing on Front-End w/ ReactJS' },
        { link: '#skills', text: 'currenly learning Next.js' },
        { link: '#about', text: 'studying at SoftUni Bulgaria' },
        { link: '#', text: 'welcome to my website :)' },
    ];

    return (
        <div className='bg-slate-900 rounded-md h-full sm:text-xl'>
